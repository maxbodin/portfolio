    ...
    <section id="whoami" className="pt-8 flex flex-col lg:flex-row items-start space-x-4">
      ...
      <div className="flex flex-col space-y-2 pt-4">
        ...
        <Badge className="p-1 px-2 bg-green-100 w-fit hover:bg-green-400 hover:cursor-pointer">
          <Link className="flex flex-row " href="mailto:wip@example.com">
            <Search className="h-4 text-green-800"/>
            <p className="px-1 text-green-700">En recherche d’Alternance !</p>
          </Link>
        </Badge>
        <p className="text-justify">Avide de connaissances et autodidacte, je suis passionné par de nombreux domaines de l’informatique (intelligence artificielle, développement logiciel/web et 3D, ...). J’ai obtenu en 2024 mon Bachelor Universitaire de Technologie Informatique à l’IUT de La Rochelle, j’ai réalisé ma troisième année de BUT en alternance au sein de l’entreprise Enedis.
        </p>
