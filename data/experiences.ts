...
export const experiencesItems: Experience[] = [
  {
    ...
    tags: ["Angular", "TypeScript", "Express", "SQL", "SDK AWS", "Python", "Selenium", "IA", "RAG", "Relation client", "Gestion de projet", "Gitlab"],
    date: "2023-2024"
  },
  {
    ...
    link: "https://www.enedis.fr",
    image_path: "/images/enedis-logo.webp",
    tags: ["Angular", "TypeScript", "Express", "SQL", "Méthodes Agiles", "TDD", "Jest", "Mocha", "Istanbul"],
    date: "2023"
  }
];