...
export const projectsItems: WorkDetails[] = [
   {
      description: 'BookHive makes it easy to organize your books, set reading goals, and track your reading activity in one place.' +
         '\n\nBookHive is a full-stack reading tracker built with Next.js. It uses Supabase Auth + PostgreSQL with server actions and middleware-based session handling, integrates the Open Library REST API with timeout and retry/backoff resilience, validates critical forms with Zod, supports EN/FR localization via next-intl, and includes reading analytics dashboards plus dynamic SEO metadata.',
      ...
      skills: [
         ...
         Skill.RADIX_UI,
         Skill.APP_ROUTER,
         Skill.SERVER_ACTIONS,
         Skill.NEXT_MIDDLEWARE,
         Skill.SSR,
         Skill.OPEN_LIBRARY_API,
         Skill.FRAMER_MOTION,
         Skill.VERCEL,
         Skill.VERCEL_ANALYTICS,
      ],
      title: 'BookHive',
      date: '2026',
   },
   {
      ...
      date: "2026",
      skills: [ Skill.VUE, Skill.TYPESCRIPT, Skill.VITE, Skill.BUN, Skill.TAILWIND, Skill.CLOUDFLARE_WORKERS, Skill.CLOUDFLARE_AI, Skill.CLOUDFLARE_KV, Skill.STABLE_DIFF, Skill.HONO, Skill.OPEN_API, Skill.ZOD, Skill.JIMP, Skill.REST_API],
   ...
   },
   {
      ...
      skills: [Skill.NEXT_JS, Skill.REACT, Skill.TYPESCRIPT, Skill.BUN, Skill.TAILWIND, Skill.SHADCN_UI, Skill.VERCEL, Skill.VERCEL_BLOB],
      title: 'Argentique',
      date: '2025',
   },
   {
      ...
      skills: [Skill.UNITY, Skill.BLENDER, Skill.C_SHARP, Skill.GAME_DESIGN, Skill.ALGO_PROG],
      title: 'Taxi Looper 🚕',
      date: '2025',
   },
   {
   ...
   },
   {
      ...
      skills: [Skill.FLUTTER, Skill.SYMFONY, Skill.API_PLATFORM, Skill.REST_API, Skill.ORS, Skill.GESTION_PROJ, Skill.TRAV_EQUIP],
   ...
   },
   {
      ...
      skills: [Skill.DEV_WEB, Skill.JAVASCRIPT, Skill.HTML, Skill.CSS, Skill.BUN],
      title: 'jo',
      date: '2024',
   },
   {
      ...
      skills: [Skill.JAVASCRIPT, Skill.HTML, Skill.CSS, Skill.DEV_WEB, Skill.LEAFLET],
   ...
   },
   {
      ...
      skills: [Skill.HTML, Skill.PHP, Skill.SYMFONY, Skill.REACT, Skill.JAVASCRIPT, Skill.DEV_WEB, Skill.REST_API, Skill.TAILWIND, Skill.CPP, Skill.TRAV_EQUIP, Skill.GIT, Skill.AGILE, Skill.DOCKER, Skill.SQL, Skill.PHPUNIT],
