...
export const projectsItems: WorkDetails[] = [
   ...
   },
   {
      ...
      images_path: [
         ...
         '/videos/opti/projects/bda-cabaret-casino.webm',
         '/images/opti/projects/bda-cabaret-circus.webp',
         '/videos/opti/projects/bda-cabaret-circus.webm',
         ...
         '/videos/opti/projects/bda-cabaret-summer-vp9.webm',
         '/images/opti/projects/bda-cabaret-abyss.webp',
         '/images/opti/projects/bda-cabaret-moulin-rouge.webp',
      ],
   ...
   },
   {
      ...
      main_image_path: '/videos/opti/projects/visite_patrimoine.webm',
   ...
   },
   {
      ...
      main_image_path: '/videos/opti/projects/island_survivors_v2.webm',
   ...
   },
   {
      ...
      main_image_path: '/videos/opti/projects/smart_campus_iot.webm',
   ...
   },
   {
      ...
      main_image_path: '/videos/opti/projects/iutfighter.webm',
