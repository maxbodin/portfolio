...
export const eventsItems: WorkDetails[] = [
   {
      ...
      skills: [Skill.ALGO_PROG, Skill.DEV_WEB, Skill.SEC, Skill.TRAV_EQUIP, Skill.COM],
   ...
   },
   {
      ...
      skills: [Skill.REACT, Skill.THREE_JS, Skill.HLSL, Skill.JAVASCRIPT, Skill.DEV_WEB, Skill.GAME_DESIGN, Skill.TRAV_EQUIP, Skill.COM],
   ...
   },
   {
      ...
      skills: [Skill.UNITY, Skill.C_SHARP, Skill.GITLAB, Skill.GESTION_PROJ, Skill.GAME_DESIGN, Skill.TRAV_EQUIP, Skill.GIMP, Skill.PAINT_NET],
   ...
   },
   {
      ...
      skills: [Skill.HTML, Skill.CSS, Skill.JAVASCRIPT, Skill.DEV_WEB, Skill.GAME_DESIGN, Skill.TRAV_EQUIP, Skill.COM],
