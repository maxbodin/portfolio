...
export const troisDItems: WorkDetails[] = [
   ...
   },
   {
      ...
      image_path: '/images/cabaret-summer-affiche.webp',
      skills: [Skill.BLENDER],
      space_only: true,
   ...
   },
   {
      ...
      image_path: '/images/cabaret-moulin-rouge-affiche.webp',
      skills: [Skill.BLENDER],
      space_only: true,
   ...
   },
   {
      ...
      image_path: '/images/compressed_s12.webp',
      skills: [Skill.BLENDER],
      space_only: true,
      title: 'Kulturap S12',
   },
   {
      ...
      image_path: '/images/compressed_s11.webp',
      skills: [Skill.BLENDER],
      space_only: true,
      title: 'Kulturap S11',
   },
