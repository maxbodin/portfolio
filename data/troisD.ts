...
export const troisDItems: WorkDetails[] = [
   ...
   },
   {
      ...
      main_image_path: '/videos/3d/cabaret-summer-visuel-vp9.webm',
      low_quality_path: '/videos/3d/cabaret-summer-visuel-vp9_low.mp4',
      thumbnail_path: '/videos/3d/cabaret-summer-visuel-vp9_thumb.jpg',
      skills: [Skill.BLENDER],
      space_only: true,
   ...
   },
   {
      ...
      main_image_path: '/images/cabaret-summer-affiche.webp',
      skills: [Skill.BLENDER],
      space_only: true,
